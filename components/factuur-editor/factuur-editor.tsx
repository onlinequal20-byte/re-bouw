      ...
      <div className="backdrop-blur-xl bg-white/10 border-b border-white/20 px-3 md:px-4 py-2 md:py-3">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <h1 className="text-white font-semibold text-base md:text-lg">Nieuwe Factuur</h1>
          </div>
        ...
        {headerExpanded && (
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2 md:gap-3 mt-3 md:mt-4">
