...
export default function NieuweOffertePage() {
  ...
  const onSubmit = async (data: OfferteFormData) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("Failed to create offerte");
      }
      ...
      toast({
        ...
        description: `Offerte ${offerte.offerteNummer} is succesvol aangemaakt.`,
      });
      ...
      toast({
        variant: "destructive",
        title: "Fout",
        description: "Er is een fout opgetreden bij het aanmaken van de offerte.",
      });
    } finally {
      setLoading(false);
    }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Voeg items toe aan de offerte</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
